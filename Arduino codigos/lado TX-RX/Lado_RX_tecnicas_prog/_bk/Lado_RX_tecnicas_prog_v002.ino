...
#define pinSinalBEnc 8 //sinal B do encoder
...
int func_Stall (){
  ...
  digitalWrite(pinRLSentidoMov, HIGH); //liga o rele de sentido de movimento para trocar o sentido do giro   
...
int func_NO_Stall (){
  ...
  digitalWrite(pinRLSentidoMov, LOW); //desativa o rele de sentido de movimento para trocar o sentido do giro    
